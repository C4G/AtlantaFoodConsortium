...
function SortableHeader({
  ...
  return (
    <th
      ...
      className='cursor-pointer select-none px-4 py-2.5 text-xs font-semibold uppercase tracking-wide text-slate-500 transition-colors hover:text-slate-800'
    >
    ...
    <div className='space-y-5'>
      ...
      <div className='flex flex-wrap items-center justify-between gap-3'>
        <div className='flex items-center gap-3'>
          <button
            onClick={onBack}
            className='flex items-center justify-center rounded-lg border border-slate-200 bg-white p-2 text-slate-500 shadow-sm transition-colors hover:bg-slate-50 hover:text-slate-900'
          >
      ...
      <div className='grid grid-cols-2 gap-3 sm:grid-cols-4'>
        ...
        <div className='rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm'>
          ...
          <p className='mt-1 text-xl font-bold text-slate-900'>{topType}</p>
        </div>
        {avgClaimHours !== null && (
          <div className='rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm'>
            <div className='flex items-center gap-2 text-slate-500'>
      ...
      <div className='rounded-lg border border-slate-200 bg-white shadow-md'>
        <div className='flex items-center justify-between border-b border-slate-200 px-4 py-3 sm:px-6'>
          <h3 className='font-semibold text-slate-800'>Product List</h3>
          <div className='relative'>
            ...
            <input
              ...
              className='rounded-md border border-slate-200 bg-slate-50 py-1.5 pl-9 pr-3 text-sm text-slate-600 placeholder:text-slate-400 focus:border-blue-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-100'
            />
          </div>
        </div>
      ...
      {typeBreakdown.length > 0 && (
        <div className='rounded-lg border border-slate-200 bg-white p-4 shadow-md sm:p-6'>
          <div className='h-72'>
            <BarChartComponent
              ...
              xAxisKey='type'
              bars={[
                { dataKey: 'count', fill: config.color, name: 'Products' },
              ]}
            />
          </div>
        </div>
